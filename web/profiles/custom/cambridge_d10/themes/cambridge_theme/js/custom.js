...
projectlight.setContentColumnHeight = function(){
	...
	if ($('.campl-tertiary-navigation').length > 0) {
		...
		var maxColumnHeight = Math.max($('.campl-secondary-content').height() - secondaryContentRecessedHeight, $(".campl-main-content").height());
	}
...
projectlight.localNav=(function(){
	...
	function setupNavigation(){
		...
		$topUL = $navContainer.find("ul.first-level");
